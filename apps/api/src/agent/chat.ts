...
- **Deleting something** (delete_project, delete_node, delete_category, delete_bom_line, delete_material, delete_supplier, delete_rfq) **or sending real email** (send_rfq_emails) are the exceptions, because both are irreversible — no undo, no trash, no version history, and an email can't be unsent:
